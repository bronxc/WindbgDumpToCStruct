struct _PEB64 {
	...
	unsigned char  Padding0[4];                       //0x004
	void*          Mutant;                            //0x008
	...
	unsigned char  Padding1[4];                       //0x054
	union {
	...
	unsigned char  Padding2[4];                       //0x074
	...
	unsigned char  Padding3[4];                       //0x10c
	...
	unsigned char  Padding4[4];                       //0x134
	...
	unsigned char  Padding5[4];                       //0x2c4
	...
	unsigned char  Padding6[4];                       //0x37c
